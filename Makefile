# This Makefile is for the Net::Domain::ExpireDate extension to perl.
#
...
#     ABSTRACT_FROM => q[ExpireDate.pm]
#     AUTHOR => q[Walery Studennikov <despair@regtime.net>]
#     NAME => q[Net::Domain::ExpireDate]
#     PREREQ_PM => { Net::Whois::Raw=>q[0], Time::Piece=>q[1] }
#     VERSION_FROM => q[ExpireDate.pm]
...
DISTNAME = Net-Domain-ExpireDate
NAME_SYM = Net_Domain_ExpireDate
VERSION = 0.11
VERSION_SYM = 0_11
XS_VERSION = 0.11
...
VENDORLIBEXP = /usr/lib/perl5/vendor_perl/5.8.0
SITELIBEXP = /usr/lib/perl5/site_perl/5.8.0
SITEARCHEXP = /usr/lib/perl5/site_perl/5.8.0/i386-linux-thread-multi
VENDORARCHEXP = /usr/lib/perl5/vendor_perl/5.8.0/i386-linux-thread-multi
LIBPERL_A = libperl.a
...
FULLEXT = Net/Domain/ExpireDate
BASEEXT = ExpireDate
PARENT_NAME = Net::Domain
DLBASE = $(BASEEXT)
...
# Where to put things:
INST_LIBDIR      = $(INST_LIB)/Net/Domain
INST_ARCHLIBDIR  = $(INST_ARCHLIB)/Net/Domain
...
TO_INST_PM = ExpireDate.pm

PM_TO_BLIB = ExpireDate.pm \
	blib/lib/Net/Domain/ExpireDate.pm
...
manifypods : pure_all ExpireDate.pm
	@$(POD2MAN) \
	ExpireDate.pm \
	$(INST_MAN3DIR)/Net::Domain::ExpireDate.$(MAN3EXT)
...
realclean purge ::  clean
	...
	rm -rf $(DISTVNAME)
	rm -f  blib/lib/Net/Domain/ExpireDate.pm
...
ppd:
	@$(PERL) -e "print qq{<SOFTPKG NAME=\"$(DISTNAME)\" VERSION=\"0,11,0,0\">\n\t<TITLE>$(DISTNAME)</TITLE>\n\t<ABSTRACT>Perl extension for obtaining expiration date</ABSTRACT>\n\t<AUTHOR>Walery Studennikov &lt;despair\@regtime.net&gt;</AUTHOR>\n}" > $(DISTNAME).ppd
	@$(PERL) -e "print qq{\t<IMPLEMENTATION>\n\t\t<DEPENDENCY NAME=\"Net-Whois-Raw\" VERSION=\"0,0,0,0\" />\n\t\t<DEPENDENCY NAME=\"Time-Piece\" VERSION=\"1,0,0,0\" />\n}" >> $(DISTNAME).ppd
...
pm_to_blib: $(TO_INST_PM)
	...
	-e "pm_to_blib({qw{ExpireDate.pm blib/lib/Net/Domain/ExpireDate.pm}},'$(INST_LIB)/auto','$(PM_FILTER)')"
	@$(TOUCH) $@
